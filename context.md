...
- The top-down cyan boundaries demarcate the actual horizontal field of view. Convert the world-space frustum half-width with the same `WORLD_TO_Y` scale used for lateral object positions; never use an arbitrary visual multiplier.
