...
- The initial composition matches the approved Far screenshot: camera at `t = 0`, stable-depth indicator at `z = 0`, the sphere centered clearly between the two cubes, teal cube well behind the sphere, and purple cube closer to the camera. Both cubes begin in mirrored corner-forward orientations and remain user-movable.
