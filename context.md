...
- Auto Play runs one compensated far-to-near sweep and stops at the near endpoint. Its button becomes a stop control while running, and any direct interaction cancels the sweep immediately.
