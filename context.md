...
- The focal-length annotation is a progressive-disclosure control. Hover, keyboard focus, or tap reveals a compact 12–70 mm slider anchored above the camera body; manual focal adjustment leaves camera position unchanged and turns Dolly Zoom off. Keep the annotation stationary and do not add a permanent second control row.
